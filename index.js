...
function weather() {
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?zip=${city},us&units=imperial&APPID=05e71cb5cf78a35509d6d9ad94d5a34b`,
    { mode: "cors" }
  )
  ...
  // 5 day forcast
  fetch(
    `https://api.openweathermap.org/data/2.5/forecast?zip=${city},us&units=imperial&APPID=05e71cb5cf78a35509d6d9ad94d5a34b`,
    { mode: "cors" }
  )
    .then(function(response) {
      return response.json();
