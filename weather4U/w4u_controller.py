from w4u_model import WeatherReport
from geopy.geocoders import Nominatim
from datetime import datetime,timedelta
import requests, os

DARK_SKY_API_KEY = os.environ['1ba625c4c0706fe811b8690edc4ca0c5']
...
class w4uController:
    ...
    def getWeatherReports(self, data, location):
        ...
        for i in range(delta.days+1):
            ...
            w4u_wr = WeatherReport(report_date, max_temperature,min_temperature, 
            summary, raining_chance, icon)        

            weather_reports.append(w4u_wr)
